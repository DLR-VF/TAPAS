...
public abstract class TPS_Mode {
     ...
     */
    protected TPS_Mode(String name, String[] attributes, boolean isFix) {
    ...
    public TPS_Mode(String name, String nameMct, int codeMct, String )
     ...
     *
     */
    public static void initUtilityFunction(Class<? extends TPS_UtilityFunction> utilityFunctionClass) {
        try {
            TPS_Mode.UTILITY_FUNCTION = utilityFunctionClass.getDeclaredConstructor().newInstance();
        } catch (Exception e) {
