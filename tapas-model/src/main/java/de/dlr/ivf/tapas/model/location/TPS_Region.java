...
public class TPS_Region implements ExtendedWritable, Iterable<TPS_TrafficAnalysisZone> {
     ...
     */
    public void initLocationChoiceSet(TPS_LocationChoiceSet locationChoiceSet) {
            LOCATION_CHOICE_SET = locationChoiceSet;
            LOCATION_CHOICE_SET.setClassReferences(this);
    }

    /**
     * This method initializes the location select model.
     */
    public void initLocationSelectModel(TPS_LocationSelectModel locationSelectModel) {
            LOCATION_SELECT_MODEL = locationSelectModel;
            LOCATION_SELECT_MODEL.setClassReferences(this);
    }
