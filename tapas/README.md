...
parameters to work, _`dbserver`_, _`dbname`_, _`dbuser`_, and _`dbpassword`_. See 
    ...
    java -cp TAPAS-<version>-all.jar de.dlr.de.dlr.ivf.installer.tapas.ivf.Installer --help
...
Start the Installer with  
    ...
    java -cp TAPAS-<version>-all.jar de.dlr.de.dlr.ivf.installer.tapas.ivf.Installer
or 

    java -cp TAPAS-<version>-all.jar de.dlr.de.dlr.ivf.installer.tapas.ivf.Installer --dbserver=localhost --dbname=tapas --dbuser=postgres --dbpassword=postgres
...
or
    ...
    java -cp TAPAS-<version>-all.jar de.dlr.de.dlr.ivf.client.runtime.tapas.ivf.SimulationControl
...
Start SimulationDaemon: 
    ...
    java -cp TAPAS-<version>-all.jar de.dlr.de.dlr.ivf.server.runtime.tapas.ivf.SimulationDaemon path/to/simulations/folder
