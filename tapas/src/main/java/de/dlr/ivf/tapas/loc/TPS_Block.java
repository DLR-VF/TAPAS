...
public class TPS_Block implements Comparable<TPS_Block> {
     ...
     *
     * @param location Location the reference should be set for
     ...
     *
     * @param taz the traffic analysis zone (tvz)
     */
    ...
    public String toString() {
        return this.getClass().getSimpleName() + " [id:" + id + " nearestPubTransStop:" + nearestPubTransStop +
                " scores:" + score + "/" + scoreCat + "]";
    }
}
