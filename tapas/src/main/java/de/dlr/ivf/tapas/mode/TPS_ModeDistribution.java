...
public class TPS_ModeDistribution {
     ...
     *
     * @param srcDis      initial modal split distribution
     * @param plan        day plan
     * @param distanceNet distance on the street net
     * @param mcc         modecontext, like , bike, car ...
     *                    flag if a bike is available
     * @return resulting probability distribution for the modes
     */
    public static TPS_DiscreteDistribution<TPS_Mode> calculateDistribution(TPS_DiscreteDistribution<TPS_Mode> srcDis, TPS_Plan plan, double distanceNet, TPS_ModeChoiceContext mcc) {
