...
public class HouseholdCostOptimumProcessor implements Processor<TPS_Household, TPS_Household> {

    private final HouseholdProcessor simulator;

    public HouseholdCostOptimumProcessor(HouseholdProcessor simulator){
        this.simulator = simulator;
    }
    @Override
    public TPS_Household process(TPS_Household entity) {

//        Map<TPS_Person, TPS_PlanEnvironment> personPlanEnvironments = simulator.process(entity);
//
