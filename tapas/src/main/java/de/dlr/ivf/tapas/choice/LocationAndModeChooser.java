...
public class LocationAndModeChooser {
     ...
     */
    public void selectLocationsAndModesAndTravelTimes(TPS_PlanningContext pc, TPS_Plan plan) {
        ...
        for (TPS_SchemePart schemePart : plan.getScheme()) {
            ...
            if (pc.carForThisPlan == null) {
                ...
                plan.getAttributes().put(TPS_AttributeReader.TPS_Attribute.HOUSEHOLD_CARS, plan.getPerson().getHousehold().getNumberOfCars());
            }
