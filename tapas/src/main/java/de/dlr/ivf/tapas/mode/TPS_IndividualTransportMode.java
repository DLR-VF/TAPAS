...
public class TPS_IndividualTransportMode extends TPS_Mode {
     ...
     *
     * @see
     * de.dlr.de.dlr.ivf.mode.tapas.ivf.TPS_Mode#getDistance(de.dlr.de.dlr.ivf.loc.tapas.ivf.TPS_Location
     * , de.dlr.de.dlr.ivf.loc.tapas.ivf.TPS_Location, int, double)
     */
    @Override
