...
public class ProcessHandler extends Thread {
     ...
     *
     * @param identifier identifier for this thread
     * @param process    corresponding process of this handler
     */
    ...
    private class ProcesshandlerThread extends Thread {
         ...
         *
         * @param ph   current process handler for identifying the thread
         * @param type type of the thread for identifying
