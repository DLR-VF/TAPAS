...
public class TPS_UtilityMNLFullComplexIntermodal extends TPS_UtilityMNL {
    ...
    //this attribute was accessed from TPS_DB_IO
...
//        }
//
//        int automaticVehicleMinDriverAge = plan.getParameters().getIntValue(ParamValue.AUTOMATIC_VEHICLE_MIN_DRIVER_AGE);
//        int automaticVehicleLevel = plan.getParameters().getIntValue(ParamValue.AUTOMATIC_VEHICLE_LEVEL);
//
//        boolean mayDriveCar = plan.getPerson().mayDriveACar(mcc.carForThisPlan, automaticVehicleMinDriverAge, automaticVehicleLevel);
//
...
//                // !!!
//
//                if (mcc.isBikeAvailable || (mcc.carForThisPlan != null && mayDriveCar)) {
//                    if (mcc.toStay.getSchemePart().isTourPart()) { // homeparts do not have attributes listed below!
//                        TPS_TourPart tourPart = (TPS_TourPart) mcc.toStay.getSchemePart();
...
//                if (mcc.carForThisPlan != null && mayDriveCar) {
...
//                        double combinesWithCarB = 0.473495331672679 * (mayDriveCar ? 1. : 0.) +
...
//                    }
//                }
//                if (writeStats) sb.append(mcc.carForThisPlan != null && mayDriveCar).append(';')
...
//                            expInterChanges = TPS_FastMath.exp(numInterchanges * interchangeFactor);
...
//                (mayDriveCar ? parameters[7] : 0) + //führerschein
