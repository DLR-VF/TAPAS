...
public class TPS_GX {
     ...
     * ----------------------------------
     *
     * @param value        value to determine the acceptance for
     * @param EBottom      parameter determining the curve in the lower part (snuggle at the bottom)
     * @param FTop         parameter determining the curve in the upper part (acceptance drop for small discrepancies)
     * @param TurningPoint turning point of the function
     ...
     */
    public static Vector<Double> tridiag(Vector<Double> a, Vector<Double> b, Vector<Double> c, Vector<Double> rhs, Vector<Double> sol) {
        double bet;
        double solC;
