...
public class CarFleetAdjuster extends TPS_BasicConnectionClass {
    ...
    private Car extractCarData(ResultSet rs) {
        ...
        try {
            ...
            if (rs.getObject("emission_type") != null) car.emission_type = rs.getInt("emission_type");
            if (rs.getObject("kba_no") != null) car.kba_no = rs.getInt("kba_no");
            if (rs.getObject("engine_type") != null) car.engine_type = rs.getInt("engine_type");
            if (rs.getObject("is_company_car") != null) car.is_company_car = rs.getBoolean("is_company_car");
            if (rs.getObject("restriction") != null) car.restriction = rs.getBoolean("restriction");
            if (rs.getObject("fix_costs") != null) car.fix_costs = rs.getDouble("fix_costs");
