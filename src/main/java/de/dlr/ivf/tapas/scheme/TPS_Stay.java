...
public class TPS_Stay extends TPS_Episode implements Comparable<TPS_Stay> {
     ...
     */
    public TPS_Stay(int id, TPS_ActivityConstant actCode, int start, int duration, double startEarlier, double startLater, double durationMinus, double durationPlus, TPS_ParameterClass parameterClass) {
