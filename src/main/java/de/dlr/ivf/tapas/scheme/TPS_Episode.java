...
public abstract class TPS_Episode implements ExtendedWritable {
     ...
     */
    public TPS_Episode(int id, TPS_ActivityConstant actCode, int start, int duration, double startEarlier, double startLater, double shorterDuration, double longerDuration, TPS_ParameterClass parameterClass) {
        this.id = id;
    ...
    public TPS_Episode clone() {
        ...
        if (this.isStay()) {
            returnVal = new TPS_Stay(id, actCode, this.originalStart, this.originalDuration, this.alphaEarlier,
                    this.alphaLater, this.betaLonger, this.betaShorter, this.parameterClass);
