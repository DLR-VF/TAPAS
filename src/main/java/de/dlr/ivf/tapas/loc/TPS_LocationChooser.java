...
public abstract class TPS_LocationChooser {
     ...
     *
     * @param comingFrom        location where you come from before the current stay
     * @param arrivalDuration   time for arriving in the new location
     * @param goingTo           location where you go to after the current stay
     * @param departureDuration time for departing the new location
     * @param activityCode      activity code of the current stay
     * @param person            who is traveling
     ...
     */
    abstract public EnumMap<TPS_Mode.ModeType, TPS_RegionResultSet> getLocationRepresentatives(TPS_Location comingFrom, double arrivalDuration, TPS_Location goingTo, double departureDuration, TPS_ActivityConstant activityCode, TPS_Person person, double startTime, SimulationType simType, TPS_Car car);
