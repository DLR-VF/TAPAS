...
public class TPS_PTCarInterchangeMatrix extends TPS_BasicConnectionClass {
	...
	public void loadMatrices(String interchangesName, String carAccessName, String carTTName, String carEgressName, 
			String ptAccessName, String ptTTName, String ptEgressName, String tableName){
	...
	public static void main(String[] args) {
		...
		worker.loadMatrices("PT_VISUM_1193_CALCULATED_AUG_2015_NTR", 
				"MIT_ACCESS_VEU2_MID2008_Y2010_REF", "CAR_1193_2010_T0_TT_TOP3", "MIT_EGRESS_VEU2_MID2008_Y2010_REF",
				"PT_VISUM_1193_CALCULATED_AUG_2015_ACT", "PT_VISUM_1193_CALCULATED_AUG_2015_NTR", "PT_VISUM_1193_CALCULATED_AUG_2015_EGT", 
				"core.berlin_matrices");
		worker.computeInterchanges();
		worker.saveInterchangeMatrixInDB("PTCAR_ACCESS_TAZ_1193", "PTCAR_INTERCHANGES_TAZ_1193", "core.berlin_matrices");
	}
