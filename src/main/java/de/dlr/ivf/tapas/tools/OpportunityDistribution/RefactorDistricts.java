...
public class RefactorDistricts extends TPS_BasicConnectionClass {
	...
	static String[] altBezirkNamen = {"Mitte", "Tiergarten", "Wedding", "Prenzlauer Berg", "Friedrichshain", 
		"Kreuzberg", "Charlottenburg", "Spandau", "Wilmersdorf", "Zehlendorf",
		"Schöneberg", "Steglitz", "Tempelhof", "Neukölln", "Treptow", "Köpenick", "Lichtenberg", "Weißensee", 
	...
	public static void main(String[] args) {
		...
		String insertAB = "INSERT INTO core.berlin_taz_mapping_values VALUES " +
				" ('23 Altbezirke', %%NUM%%," +
				" (SELECT array_agg(taz_id) FROM core.berlin_taz WHERE %%WHERECLAUSE%%)," +
				" '%%NAME%%')";
		String locAB;
		...
		for (String ab : altbezirke.keySet()){//iterieren durch Altbezirke
			...
			locAB = insertAB.replaceAll("%%NUM%%", ab).replaceAll("%%NAME%%", bezirkName(ab)).replaceAll("%%WHERECLAUSE%%",
