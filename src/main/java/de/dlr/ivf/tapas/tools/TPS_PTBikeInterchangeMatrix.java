...
public class TPS_PTBikeInterchangeMatrix extends TPS_BasicConnectionClass {
	...
	public static void main(String[] args) {
		...
		worker.loadAndInitMatrices("PT_VISUM_1193_CALCULATED_AUG_2015_NTR", "BIKE_1193TAZ_TT_14KMH", "PT_VISUM_1193_CALCULATED_AUG_2015_SUM_TT", "core.berlin_matrices");
		worker.computeInterchanges();
		worker.saveInterchangeMatrixInDB("PTBIKE_ACCESS_TAZ_1193", "PTBIKE_EGRESS_TAZ_1193", "PTBIKE_INTERCHANGES_TAZ_1193", "core.berlin_matrices");
	}
