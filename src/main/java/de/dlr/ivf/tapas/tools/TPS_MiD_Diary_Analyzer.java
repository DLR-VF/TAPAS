...
//		regions.put("polgk =5", "_PolGK5");
        ...
        for (Entry<String, String> t : times.entrySet()) {
            for (Entry<String, String> r : regions.entrySet()) {
                ...
                worker.printDistributionVectorSQLInserts("core.global_scheme_class_distributions_mid",
                        "MID_2008_" + groupCol_name + t.getValue() + r.getValue(), printOnScreen);
    ...
    public void printDiariesSQLInserts(String table_episode, String table_schemes, boolean print) {
        ...
        activityMapping.put(getMappingKey(4, 502, 0),
                53);  //Shopping long term: sonstige Ware (Kleidung, Möbel, Hausrat)
        ...
        activityMapping.put(getMappingKey(4, 3307, 0),
                50);  //Shopping kein Einkaufs-, Erledigungs- und Freizeitweg?!?!?
        ...
        activityMapping.put(getMappingKey(5, 3307, 0),
                522); //private Erledigung: kein Einkaufs-, Erledigungs- und Freizeitweg?!?!?
        ...
        activityMapping.put(getMappingKey(6, 3307, 0),
                799); //Bringen+Holen: kein Einkaufs-, Erledigungs- und Freizeitweg?!?!?
        ...
        activityMapping.put(getMappingKey(7, 3307, 0),
                740); //Freizeit: kein Einkaufs-, Erledigungs- und Freizeitweg?!?!?
                        ...
                        for (String k : d.accompaningPersons) { // go through acompaning persons 1st time
                            ...
                            if (company != null) { //Diary found?
                                ...
                                if (companyAct != null) { //found a trip?
                                    ...
                                    if (companyAct.accompaningPersons.contains(e.getKey()) &&
