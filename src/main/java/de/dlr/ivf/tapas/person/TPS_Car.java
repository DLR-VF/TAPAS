...
public class TPS_Car  {
	...
	public enum FuelType {
		BENZINE	(ParamValue.MIT_GASOLINE_COST_PER_KM, ParamValue.MIT_GASOLINE_COST_PER_KM_BASE, ParamValue.MIT_VARIABLE_COST_PER_KM, ParamValue.MIT_VARIABLE_COST_PER_KM_BASE, ParamValue.MIT_RANGE_CONVENTIONAL, ParamValue.MIT_RANGE_CONVENTIONAL),
		DIESEL	(ParamValue.MIT_DIESEL_COST_PER_KM, ParamValue.MIT_DIESEL_COST_PER_KM_BASE, ParamValue.MIT_VARIABLE_COST_PER_KM, ParamValue.MIT_VARIABLE_COST_PER_KM_BASE, ParamValue.MIT_RANGE_CONVENTIONAL, ParamValue.MIT_RANGE_CONVENTIONAL),
		GAS		(ParamValue.MIT_GAS_COST_PER_KM, ParamValue.MIT_GAS_COST_PER_KM_BASE, ParamValue.MIT_VARIABLE_COST_PER_KM, ParamValue.MIT_VARIABLE_COST_PER_KM_BASE, ParamValue.MIT_RANGE_CONVENTIONAL, ParamValue.MIT_RANGE_CONVENTIONAL),
		EMOBILE	(ParamValue.MIT_ELECTRO_COST_PER_KM, ParamValue.MIT_ELECTRO_COST_PER_KM_BASE, ParamValue.MIT_VARIABLE_COST_PER_KM, ParamValue.MIT_VARIABLE_COST_PER_KM_BASE, ParamValue.MIT_RANGE_EMOBILE, ParamValue.MIT_RANGE_EMOBILE),
		PLUGIN	(ParamValue.MIT_PLUGIN_COST_PER_KM, ParamValue.MIT_PLUGIN_COST_PER_KM_BASE, ParamValue.MIT_VARIABLE_COST_PER_KM, ParamValue.MIT_VARIABLE_COST_PER_KM_BASE, ParamValue.MIT_RANGE_PLUGIN, ParamValue.MIT_RANGE_PLUGIN),
		FUELCELL(ParamValue.MIT_FUELCELL_COST_PER_KM, ParamValue.MIT_FUELCELL_COST_PER_KM_BASE, ParamValue.MIT_VARIABLE_COST_PER_KM, ParamValue.MIT_VARIABLE_COST_PER_KM_BASE, ParamValue.MIT_RANGE_CONVENTIONAL, ParamValue.MIT_RANGE_CONVENTIONAL);
		
		private ParamValue costPerKilometer;
		private ParamValue variableCostsPerKilometer;
		private ParamValue range;
		private ParamValue costPerKilometerBase;
		private ParamValue variableCostsPerKilometerBase;
		private ParamValue rangeBase;
	...
	public static TPS_Car selectCar(TPS_Plan plan, TPS_TourPart tourpart ){
		...
		TPS_Car[] availableCars = plan.getPerson().getHousehold().getAvailableCars(tourpart.getOriginalSchemePartStart(), tourpart.getOriginalSchemePartEnd());
	...
	public double getVariableCostPerKilometer(SimulationType simType){
		return this.companyCar?0:this.parameterClass.getDoubleValue(type.getVariableCostsPerKilometer(simType))*this.getKBAVariableCostPerKilometerFactor();
	}
	 ...
	 *            
	 * @param payToll
	 *            flag to indicate that this car pays a entry/exit toll
	 * 
	 * @return success of this action 
	 */
	...
	public boolean unPickCar(int start, int end) {
		boolean success = false;
		if ( availability.remove(start, end)) { //remove returns true if a timeline-entry with the given start and end existed and was removed
			success=true;
		}
		return success;
	}	
