...
public class TPS_Household implements ExtendedWritable {
	...
	private SortedMap<Integer, TPS_Person> members;
	...
	public String toString(String prefix) {
		return prefix + this.getClass().getSimpleName() + "[id=" + this.getId() + ", type=" + this.getType() + ", members="
				+ this.members.size() + ", cars=" + this.getCarNumber() + ", income=" + this.getIncome() + "]";
	}
