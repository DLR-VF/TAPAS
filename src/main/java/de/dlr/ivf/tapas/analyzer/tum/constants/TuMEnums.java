...
public class TuMEnums {
	...
	public enum Categories {
		RegionCode(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.RegionCode.class,
				null), //
		PersonGroup(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.PersonGroup.class,
				"person_group"), //
		DistanceCategory(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.DistanceCategory.class,
				"distance_category"), //
		DistanceCategoryDefault(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.DistanceCategoryDefault.class,
				"distance_category"), //
		DistanceCategoryEquiFive(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.DistanceCategoryEquiFive.class,
				null), //
		DistanceCategoryEquiTen(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.DistanceCategoryEquiTen.class,
				null), //
		TripIntention(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.TripIntention.class,
				"trip_intention"), //
		Mode(de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.Mode.class,
				"trip_mode"), //
		Job(de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.Job.class, null), //
		TravelTime(
				de.dlr.ivf.tapas.analyzer.tum.constants.TuMEnums.TravelTime.class,
				null);
		...
		public static Categories getByClass(Class<?> theClass) {
			for (Categories c : values()) {
				if (c.getEnumeration().equals(theClass))
					return c;
			}

			throw new IllegalArgumentException("The given class "
					+ theClass.getSimpleName() + " is not valid.");
		}
	...
	public enum RegionCode {
		 ...
		 *             if the <code>id</code> cannot be assigned.
		 * @return
		 */
...
//			return values()[0];
	...
	public enum TripIntention {
		...
		TRIP_33(3, "Private Erledigungen", generateSet(Activity.ACT_10,
				Activity.ACT_12, Activity.ACT_32, Activity.ACT_522,
				Activity.ACT_611, Activity.ACT_631)), //
		TRIP_34(4, "Einkauf", generateSet(Activity.ACT_50, Activity.ACT_51, Activity.ACT_52, Activity.ACT_53, Activity.ACT_54, Activity.ACT_55)), //
		TRIP_35(5, "Freizeit", generateSet(Activity.ACT_231, Activity.ACT_300,
				Activity.ACT_511, Activity.ACT_512, Activity.ACT_531,
				Activity.ACT_533, Activity.ACT_640, Activity.ACT_700,
				Activity.ACT_711, Activity.ACT_720, Activity.ACT_721,
				Activity.ACT_722, Activity.ACT_723, Activity.ACT_724,
		 ...
		 *             konnte
		 */
		public static TripIntention getById(int id)
				throws IllegalArgumentException {
			for (TripIntention ti : values()) {
				if (ti.getId() == id) {
					return ti;
	...
	public enum DistanceCategory {
		 ...
		 * @param filter
		 * @throws IllegalArgumentException
		 *             if the length of the filter does not coincide with the
		...
		public static double[] createFilteredDistances(boolean[] filter) {
			...
			if (len != DistanceCategoryDefault.values().length)
				throw new IllegalArgumentException(
			...
			while (idxF < len) {
				if (filter[idxF]) {
					result[idxR++] = DistanceCategoryDefault.values()[idxF]
							.getMaxDistance();
				}
	...
	public enum DistanceCategoryDefault {
		 ...
		 * @param maxDistance
		 *            die maximale Distanz (ausschließlich, der angegebene Wert
		 ...
		 * @throws IllegalArgumentException
		 *             wenn die ID keiner Kategorie zugeordnet werden kann
		 */
		public static DistanceCategoryDefault getById(int id)
				throws IllegalArgumentException {
		 ...
		 * 
		 * @param categories
		 *            Elemente müssen aufsteigend sortiert sein
		 * @return
		 */
		public static String createDistanceCategoriesName(
				List<DistanceCategoryDefault> categories) {
			if (categories.contains(CAT_1) && categories.contains(CAT_8)) {
				...
				String descEnd = categories.get(categories.size() - 1)
						.getDescription();
				String beginning = descBeginning.substring(0,
						descBeginning.indexOf('-'));
		 ...
		 * @return
		 */
		public static String createDistanceCategoriesID(
				List<DistanceCategoryDefault> categories) {
	...
	public enum DistanceCategoryEquiFive {
		 ...
		 *             wenn die ID keiner Kategorie zugeordnet werden kann
		 */
		public static DistanceCategoryEquiFive getById(int id)
				throws IllegalArgumentException {
	...
	public enum DistanceCategoryEquiTen {
		 ...
		 *             wenn die ID keiner Kategorie zugeordnet werden kann
		 */
		public static DistanceCategoryEquiTen getById(int id)
				throws IllegalArgumentException {
	...
	public enum PersonGroup {
		PG_1(0, "Vollzeit/Teilzeit Frau mit Pkw", generateSet(Job.JOB_5,
				Job.JOB_11, Job.JOB_19)), //
		PG_2(1, "Vollzeit/Teilzeit Frau ohne Pkw", generateSet(Job.JOB_12,
				Job.JOB_20)), //
		PG_3(2, "Vollzeit/Teilzeit Mann mit Pkw", generateSet(Job.JOB_3,
				Job.JOB_9, Job.JOB_17)), //
		PG_4(3, "Vollzeit/Teilzeit Mann ohne Pkw", generateSet(Job.JOB_10,
				Job.JOB_18)), //
		PG_5(4, "nicht erwerbstätig Frau mit Pkw", generateSet(Job.JOB_8,
				Job.JOB_15, Job.JOB_23)), //
		PG_6(5, "nicht erwerbstätig Frau ohne Pkw", generateSet(Job.JOB_16,
				Job.JOB_24)), //
		PG_7(6, "nicht erwerbstätig Mann mit Pkw", generateSet(Job.JOB_6,
				Job.JOB_13, Job.JOB_21)), //
		PG_8(7, "nicht erwerbstätig Mann ohne Pkw", generateSet(Job.JOB_14,
				Job.JOB_22)), //
		PG_9(8, "Rentner mit Pkw", generateSet(Job.JOB_25, Job.JOB_27,
				Job.JOB_29, Job.JOB_31)), //
		PG_10(9, "Rentner ohne Pkw", generateSet(Job.JOB_26, Job.JOB_28,
				Job.JOB_30, Job.JOB_32)), //
		PG_11(10, "Schüler/Student", generateSet(Job.JOB_1, Job.JOB_2)), //
		PG_12(11, "Kinder", generateSet()), //
		PG_13(
				12,
				"4 und 7: junge Erwachsene bis 24 Jahre mit und ohne PKW, erwerbstätig und nichterwerbstätig",
		 ...
		 *             konnte
		 */
		public static PersonGroup getById(int id)
				throws IllegalArgumentException {
			for (PersonGroup pg : values()) {
				if (pg.getId() == id) {
					return pg;
	...
	public enum Mode {
		WALK(0, "Fuß"), BIKE(1, "Rad"), MIV(2, "Pkw"), MIV_PASS(3, "PkwMf"), TAXI(
				4, "Taxi"), PT(5, "ÖV"), TRAIN(6, "Zug");
	...
	public enum Job {
		JOB_1(1), JOB_2(2), JOB_3(3), JOB_4(4), JOB_5(5), JOB_6(6), JOB_7(7), JOB_8(
				8), JOB_9(9), JOB_10(10), JOB_11(11), JOB_12(12), JOB_13(13), JOB_14(
				14), JOB_15(15), JOB_16(16), JOB_17(17), JOB_18(18), JOB_19(19), JOB_20(
				20), JOB_21(21), JOB_22(22), JOB_23(23), JOB_24(24), JOB_25(25), JOB_26(
				26), JOB_27(27), JOB_28(28), JOB_29(29), JOB_30(30), JOB_31(31), JOB_32(
				32);
	...
	public static class PersonGroupAnalyzer extends AnalyzerBase<PersonGroup> {
		...
		private HashMap<CategoryCombination, HashSet<Integer>> personSets;
		...
		public PersonGroup assignTrip(TapasTrip trip) {
			if (keepsPersonCnt) {
				...
				cats[analyzers.length] = PersonGroup.getByJob(Job.getById(trip
						.getJob()));
	...
	public static class DefaultDistanceCategoryAnalyzer extends
			AnalyzerBase<DistanceCategoryDefault> {
		@Override
	...
	public static class EquiFiveDistanceCategoryAnalyzer extends
			AnalyzerBase<DistanceCategoryEquiFive> {
		@Override
	...
	public static class EquiTenDistanceCategoryAnalyzer extends
			AnalyzerBase<DistanceCategoryEquiTen> {
		@Override
	...
	public static class DistanceCategoryAnalyzer extends
			AnalyzerBase<DistanceCategory> {
		 ...
		 * 
		 * @param distances
		 *            in meters. Must be in strict ascending order.
		 * @throws IllegalArgumentException
		 *             if the length of distances does not coincide with the
		...
		public DistanceCategoryAnalyzer(double[] distances) {
			if (distances.length != DistanceCategory.values().length) {
				throw new IllegalArgumentException(
						"There must be a distance given for each category.");
			}
			if (distances[0] == Double.MAX_VALUE)
				throw new IllegalArgumentException(
		...
		public ArrayList<DistanceCategory> getDistanceCategories() {
			...
			for (Entry<DistanceCategory, String> e : nameMap.entrySet()) {
				if (!e.getValue().equals(DistanceCategory.NOT_USED))
					result.add(e.getKey());
			}
		...
		public DistanceCategory assignTrip(TapasTrip trip) {
			...
			if (dist < distances[0])
				return DistanceCategory.CAT_1;

			int idx = 1;

			while (dist >= distances[idx] && idx < distances.length - 1)
				idx++;

			if (distances[idx] == Double.MAX_VALUE)
				return DistanceCategory.CAT_8;
			else
				return DistanceCategory.values()[idx];
		}
		...
		private void buildNameMap() {
			...
			nameMap.put(DistanceCategory.CAT_1,
					"< " + String.format("%d", (int) distances[0] / 1000)
							+ " km");
			...
			while (idx < distances.length - 1) {
				...
				if (newD == Double.MAX_VALUE) {
					nameMap.put(DistanceCategory.values()[idx],
							DistanceCategory.NOT_USED);
				} else {

					String s = String.format("%d-%d km", (int) oldD / 1000,
							(int) newD / 1000);
	...
	public static class TripIntentionAnalyzer extends
			AnalyzerBase<TripIntention> {
		@Override
		public TripIntention assignTrip(TapasTrip trip) {
			TripIntention ti = TripIntention.getByActivity(Activity
					.getById(trip.getActCode()));
			if (trip.isBackHome())
				ti = TripIntention.TRIP_37;
			return ti;
		}
	}
