...
public class AnalyzerTest {
	...
	public static void testEnumSets() {
		EnumSet<Categories> es1 = EnumSet.of(Categories.RegionCode,
				Categories.Mode);
		EnumSet<Categories> es2 = EnumSet.of(Categories.Mode,
	...
	public static void testCategoryCombination() {
		...
		ArrayList<CategoryCombination> cats = CategoryCombination
				.listAllCombinations(Categories.Mode,
						Categories.DistanceCategory, Categories.PersonGroup,
		...
		System.out
				.println(Categories
						.isValid(de.dlr.ivf.tapas.analyzer.inputfileconverter.Job.JOB_1));
