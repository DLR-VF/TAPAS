...
public class TapasTripConverter {
    ...
    private final List<File> tripFiles;
        ...
        if (reader != null) {
            ...
            if (record != null) {
                ...
                console.insertString(console.getLength(),
                        "TripConv gelesen " + (int) (100.0 * tripFileCounter / tripFiles.size()) + "%: " +
                                reader.getFileName() + "\n", null);
                ...
                try {// set new trip file
                    ...
                    // e1.printStackTrace();
                    System.out.println("File not found convertNextTrip (FileIteration)");
                    return false;
                } catch (IOException e1) {
                    // e1.printStackTrace();
                    System.out.println("IOException convertNextTrip (FileIteration)");
                    return false;
                }
            }
        } else {
    ...
    public String getTripFile() {
        if (currentTripFile != null) return currentTripFile.getAbsolutePath();
        else return null;
    }
