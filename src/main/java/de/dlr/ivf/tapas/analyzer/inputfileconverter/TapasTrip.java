...
public class TapasTrip {
    ...
    static {
        ...
        String[] tr = {"travel_time_sec", "mode", "distance_bl_m", "distance_real_m", "activity", "is_home", "p_id", "hh_id", "start_time_min"};
...
//	private double comingY;
    ...
    public TapasTrip(int activityCode, int activityStart, int activityDuration, int bbrTypeStart, int bbrTypeHome, int tazIdStart, int tazIdEnd, int locIdStart, int locIdEnd, double distBL, double dist, int mode, int pId, int hhId, int job, int startTime, double travelTime, boolean isBackHome) {
    ...
    public TapasTrip copy() {
        ...
        TapasTrip t = new TapasTrip(activityCode, activityStart, activityDuration, bbrTypeStart, bbrTypeHome,
                tazIdStart, tazIdEnd, locIdStart, locIdEnd, distBL, dist, mode, pId, hhId, job, startTime, travelTime,
                isBackHome);
...
//	}
    ...
    public void setValues(String[] values) {
        if (keyMapping == null) throw new IllegalArgumentException("KeyMapping must be generated first.");
    ...
    public String toString() {
        return "(ID:" + getIdPers() + ", Job:" + getJob() + ", Act:" + getActCode() + ", isBH:" + isBackHome() +
                ", isFH:" + isFromHome() + ")";
    }
    ...
    public enum Sex {
         ...
         *
         * @param i_sex Code for sex (cf. declaration)
        ...
        public static Sex convert(int i_sex) throws IllegalArgumentException {
            for (Sex current : values()) {
                if (current.m_sex == i_sex) return current;
            }
    ...
    public enum header {
        ...
        BBR_TYPE_HOME("bbr_type_home"), DIST("dist", "distance_bl_m"), //
        ...
        public static header fromString(String s) {
            ...
            for (header h : values()) {
                if (h.headerSet.contains(s)) return h;
            }
