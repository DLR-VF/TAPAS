...
public interface TPS_LoggingInterface {
    ...
    enum SeverenceLogLevel {
		OFF(0, ParamString.LOG_LEVEL_OFF),
		FATAL(1, ParamString.LOG_LEVEL_FATAL),
		ERROR(2, ParamString.LOG_LEVEL_ERROR),
		SEVERE(3, ParamString.LOG_LEVEL_SEVERE),
		WARN(4, ParamString.LOG_LEVEL_WARN),
		INFO(5, ParamString.LOG_LEVEL_INFO),
		DEBUG(6, ParamString.LOG_LEVEL_DEBUG),
		FINE(7, ParamString.LOG_LEVEL_FINE),
		FINER(8, ParamString.LOG_LEVEL_FINER),
		FINEST(9, ParamString.LOG_LEVEL_FINEST),
		ALL(10, ParamString.LOG_LEVEL_ALL);
		private int index;

		/**
		 * The corresponding ParamString to this log level
		 */
		private ParamString key;
		 ...
		 *            index of this level
		 * @param key
		 *            corresponding key of this level
		 */
