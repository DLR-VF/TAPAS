...
public class ValidateModeAction implements TPS_PlanStateAction{
    ...
    public ValidateModeAction(TPS_ModeValidator mode_validator, TourContext tour_context, TPS_PlanningContext planing_context, TPS_PlannedTrip planned_trip){
    ...
    public void run() {
        ...
        this.mode_validator.validateMode(planning_context, tour_context.getModeContext() ,tour_context.getCurrentLocation(), tour_context.getNextLocation(), planning_trip);
