...
import de.dlr.ivf.tapas.execution.sequential.action.TPS_PlanStatePersistenceAction;
import de.dlr.ivf.tapas.execution.sequential.action.TPS_PlanStateSelectLocationAndModeAction;
...
public class TPS_PlanStateMachineFactory {
    ...
    public static TPS_PlanStateMachine createTPS_PlanStateMachineWithSimpleStates(TPS_Plan plan, TPS_TripWriter writer, TPS_DB_IOManager pm, Map<Integer, TPS_CarSharingMediator> car_sharing_mediators){
        ...
        TPS_PlanStateMachine stateMachine = new TPS_PlanStateMachine("Person: "+plan.getPerson().getId());
