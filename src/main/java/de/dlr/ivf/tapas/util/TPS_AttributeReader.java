...
public class TPS_AttributeReader {
    ...
    public enum TPS_Attribute {
        CURRENT_DISTANCE_CLASS_CODE_MCT, CURRENT_DISTANCE_CLASS_CODE_VOT, CURRENT_EPISODE_ACTIVITY_CODE_MCT, CURRENT_EPISODE_ACTIVITY_CODE_TAPAS, CURRENT_EPISODE_ACTIVITY_CODE_VOT, CURRENT_MODE_CODE_VOT, CURRENT_TAZ_SETTLEMENT_CODE_TAPAS, HOUSEHOLD_CARS, HOUSEHOLD_INCOME_CLASS_CODE, PERSON_AGE, PERSON_AGE_CLASS_CODE_PERSON_GROUP, // change to FSO also in files
        PERSON_AGE_CLASS_CODE_STBA, PERSON_DRIVING_LICENSE_CODE, PERSON_SEX_CLASS_CODE, PERSON_HAS_BIKE
