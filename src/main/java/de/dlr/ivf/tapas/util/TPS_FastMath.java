...
public class TPS_FastMath {
	 ...
	 * @see
	 *
	 * <a href="http://stackoverflow.com/questions/10552280/fast-exp-calculation-possible-to-improve-accuracy-without-losing-too-much-perfo"></a>
	 * @param x
	 * @return exp of x 
	 */
	public static double exp(double x) {
		...
		if(	Double.isNaN(returnVal) || Double.isInfinite(returnVal) ||
			returnVal<1e-32 || returnVal>1e32
				){ //cap and nan-handling
	 ...
	 */
	static double[] ExpAdjustment = new double[] {
        1.040389835,
        1.039159306,
        1.037945888,
        1.036749401,
