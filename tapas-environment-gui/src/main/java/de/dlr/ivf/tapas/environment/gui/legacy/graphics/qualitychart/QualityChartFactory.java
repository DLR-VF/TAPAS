...
public class QualityChartFactory {
    ...
    public static JFreeChart createChart(ArrayList<QualityChartData> data) {
        ...
        // TODO delete EnumSet
        EnumSet<QualityChartDataset.Key> es = EnumSet.allOf(QualityChartDataset.Key.class);
        ...
        // High quality data
        int i = dataset.indexOf(QualityChartDataset.Key.DATA_HIGH);
        ...
        // Medium quality data
        i = dataset.indexOf(QualityChartDataset.Key.DATA_MED);
        renderer.setSeriesLinesVisible(i, false);
        renderer.setSeriesShapesVisible(i, true);
        renderer.setSeriesVisibleInLegend(i, true);
        ...
        // low quality data
        i = dataset.indexOf(QualityChartDataset.Key.DATA_LOW);
        renderer.setSeriesLinesVisible(i, false);
        renderer.setSeriesShapesVisible(i, true);
        renderer.setSeriesVisibleInLegend(i, true);
        ...
        i = dataset.indexOf(QualityChartDataset.Key.LOWER_CONFIDENCE);
        ...
        i = dataset.indexOf(QualityChartDataset.Key.UPPER_CONFIDENCE);
        renderer.setSeriesLinesVisible(i, true);
        renderer.setSeriesShapesVisible(i, false);
        ...
        // optimal line
        i = dataset.indexOf(QualityChartDataset.Key.OPTIMAL);
        renderer.setSeriesLinesVisible(i, true);
        renderer.setSeriesShapesVisible(i, false);
        renderer.setSeriesVisibleInLegend(i, false);
        renderer.setSeriesPaint(i, Color.BLACK);
        ...
        // GEH5
        i = dataset.indexOf(QualityChartDataset.Key.LOWER_GEH5);
        renderer.setSeriesLinesVisible(i, true);
        renderer.setSeriesShapesVisible(i, false);
        renderer.setSeriesVisibleInLegend(i, true);
        renderer.setSeriesPaint(i, Color.BLACK);
    ...
    private static class QualityChartLegendGerator implements XYSeriesLabelGenerator {
        ...
        public String generateLabel(XYDataset dataset, int series) {
            ...
            QualityChartDataset.Key key = (QualityChartDataset.Key) qcd.getSeriesKey(series);

            if (QualityChartDataset.DATASERIES.contains(key)) {
                return QualityChartDataset.Key.getQuality(key).toString();
            } else if (key == QualityChartDataset.Key.LOWER_CONFIDENCE) {
                return "Confidence Interval";
            } else if (key == QualityChartDataset.Key.LOWER_GEH5) {
                return "GEH5";
            }
            return "";
        }
