...
package de.dlr.ivf.tapas.environment.gui.legacy.tum;
 ...
 * {@link JFileChooser} like SimulationMonitorOld#tumFileChooser(int).</p>
    ...
    protected Void doInBackground() throws Exception {
        ...
        for (int i = 0; i < simcount; i++) {
            ...
            this.firePropertyChange("intermediate", null,
                    null); //reset progress bars in {@link SimulationMonitorOld} after one simulation is finished
