...
public class ModalSplitChartFrame extends ChartFrame implements ActionListener {
    ...
    public ModalSplitChartFrame(String reference, String model, String title) throws ClassNotFoundException, IOException {
        ...
        mClearSelection = new JMenuItem(MultilanguageSupport.getString("MENU_CLEAR_SELECT"));
        mClearSelection.addActionListener(this);
        getChartPanel().getPopupMenu().add(mClearSelection);

        mSaveSelection = new JMenuItem(MultilanguageSupport.getString("MENU_SAVE_TO_CLIPBOARD"));
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        ModalSplitChartFrame frame = new ModalSplitChartFrame(referenceKey, modelKey, title);
...
//			System.out.println("All clear!");
            ...
            StringSelection stringSelection = new StringSelection(getChart().exportSelected());
