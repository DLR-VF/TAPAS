        ...
        return new Task<>() {
            ...
            protected Void call() throws Exception {
                ...
                try {
                    ...
                    parameters = readParameters(simFile, simKey);

                    //lock the simulation table
                    //String lockQuery= "LOCK TABLE " + simulationsDao.uri() + " IN ROW EXCLUSIVE MODE;";
                    SimulationEntry s = new SimulationEntry(-1,simKey,"",0, Timestamp.valueOf(LocalDateTime.now()),Timestamp.valueOf(LocalDateTime.now()),null,"", null);
                    simulationsDao.save(s);
