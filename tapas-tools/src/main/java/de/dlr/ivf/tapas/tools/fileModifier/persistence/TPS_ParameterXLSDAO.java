...
public class TPS_ParameterXLSDAO extends AbstractTPS_ParameterDAO {
    ...
    private final IndexedColors[] indexedColors = new IndexedColors[]{IndexedColors.LIGHT_CORNFLOWER_BLUE, IndexedColors.LIGHT_GREEN, IndexedColors.WHITE};
    private final String[] prefixes = new String[]{"run_", "file_", "db_", "par_", "log_"};
    ...
    public TPS_ParameterXLSDAO() {
        ...
        map0.put(ParamString.UTILITY_FUNCTION_NAME, "tpsModeDistribution.useBetaBudgets");
