        ...
        for (int fromT = 0; fromT < sizeTAZ; ++fromT) {
            for (int toT = 0; toT < sizeTAZ; ++toT) {
                if (fromT != toT || destination[fromT][toT] > 0) {
                    destination[fromT][toT] = this.tazCentroids.get(fromT + 1).distanceTo(
                            this.tazCentroids.get(toT + 1));
                } else {
                ...
                if (line != null) {
                    ...
                    if (tokens != null) {
                        ...
                        if (tokens.countTokens() != destination.length) {
                            System.err.println("Input error! File " + name + " size tokens: " + tokens.countTokens() +
                                    " size array " + destination.length);
                        }
                        i = 0;
                ...
                if (line != null) {
                    ...
                    if (tokens != null) {
                        ...
                        if (tokens.countTokens() != 3) {
                            System.err.println("Input error! File " + string + " size tokens: " + tokens.countTokens() +
                                    " ecpected tokens: 3");
                        } else { //parse data
