...
public class TPS_HouseholdToLocationCreator {
...
//                    "JOIN core.berlin_blocks As foo2 on foo2.blk_id=foo.blocknr " + "WHERE bar.hh_key='" + key +
//                    "' GROUP BY foo2.blk_id, foo2.blk_coordinate, foo2.blk_taz_id";
...
//            System.err.println(
//                    this.getClass().getCanonicalName() + " createTable: SQL-Error during statement: " + query);
//            e.printStackTrace();
//        }
...
//            query = "INSERT INTO core.berlin_locations VALUES (" + loc.loc_id + ", " + loc.loc_blk_id + "," +
//                    loc.loc_taz_id + "," + loc.loc_code + "," + "'" + loc.loc_enterprise + "'," + loc.loc_capacity +
//                    "," + (loc.loc_has_fix_capacity ? "TRUE" : "FALSE") + "," + "st_setsrid(st_makepoint(" + loc.x +
//                    "," + loc.y + "),4326)," + "null," + "-1," + "null," + "null" + ")";
