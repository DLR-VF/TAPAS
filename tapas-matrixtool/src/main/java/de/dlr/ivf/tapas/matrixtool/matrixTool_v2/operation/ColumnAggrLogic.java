...
public class ColumnAggrLogic extends AbstractAggregationLogic<Number> {
	...
	private ArrayList<ArrayList<Number>> gatherLogicUnitSets() {
		...
		MemoryList<GenericIdentifyable> logicUnit = model.getColumnIDs();
		MemoryList<GenericIdentifyable> logicUnitItems = model.getRowIDs();
