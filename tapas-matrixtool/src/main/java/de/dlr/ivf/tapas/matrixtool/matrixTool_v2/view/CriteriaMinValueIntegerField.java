...
public class CriteriaMinValueIntegerField extends AbstractIntegerValueCriteriaField{

	public CriteriaMinValueIntegerField(IUnaryCriteriaController<Integer> control, RangeCriteria<Integer> item,
			String text) {
	...
	public void actionPerformed(ActionEvent arg0) {
		try {
			if (isValueValid())
				((IUnaryCriteriaController<Integer>)control).changeCritMinValue(
