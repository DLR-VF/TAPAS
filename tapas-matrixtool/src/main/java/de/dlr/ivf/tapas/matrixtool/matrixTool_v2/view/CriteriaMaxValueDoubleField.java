...
public class CriteriaMaxValueDoubleField extends AbstractDoubleValueCriteriaField{

	public CriteriaMaxValueDoubleField(IUnaryCriteriaController<Double> control, RangeCriteria<Double> item,
			String text) {
	...
	public void actionPerformed(ActionEvent arg0) {
		try {
			if (isValueValid())
				((IUnaryCriteriaController<Double>)control).changeCritMaxValue(
